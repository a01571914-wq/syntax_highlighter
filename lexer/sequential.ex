...
# Evidence 2 — Sequential Syntax Highlighter
# How to run:
#   iex sequential.ex
...
defmodule SequentialHighlighter do
  @moduledoc """
  ...
  @doc """
  Highlights every C++ file in `input_dir` sequentially and writes each HTML
  file.
  ...
  Usage: SequentialHighlighter.measure_time(&SequentialHighlighter.run/1, ["cpp_examples"])
  """
...
IO.puts("Sequential syntax highlighter")
IO.puts(String.duplicate("-", 40))

seconds = SequentialHighlighter.measure_time(&SequentialHighlighter.run/1, [input_directory])
